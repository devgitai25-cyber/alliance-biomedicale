...
import { JwtAuthGuard, AdminGuard, OptionalJwtAuthGuard } from '../auth/guards/auth.guard';
...
export class OrdersController {
    ...
    create(@Body() createOrderDto: CreateOrderDto, @Req() req) {
        // Extract userId if available (OptionalJwtAuthGuard populates req.user when token is present)
