...
async function main() {
    ...
    for (const setting of settingsData) {
        // use any to bypass strict typing if Settings not yet generated in client
        // but since we ran migration, it should be there.
        // However, the import { PrismaClient } might strictly need to be regenerated if using VSCode types.
        // In runtime it works.
