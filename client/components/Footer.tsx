                    ...
                    <div>
                        ...
                        <div className="space-y-3 text-sm text-gray-text font-body">
                            <p className="flex items-center gap-2.5 hover:text-teal-main transition-colors">
                                ...
                                <a href="mailto:contact@alliance-bio.tn" className="hover:text-teal-main transition-colors">
                                    contact@alliance-bio.tn
                                </a>
                            </p>
                            <p className="flex items-center gap-2.5 hover:text-teal-main transition-colors">
                                <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
                                ...
                                <a href="tel:+21671123456" className="hover:text-teal-main transition-colors">
                                    +216 71 123 456
                                </a>
                            </p>
                        </div>
